/* global React, TPL, Field, TextInput, DropSelect, DatePicker, ChannelPicker, ChoiceChips, LangTabs, HiTextarea, VariablePanel, SegmentMeter, DevicePreview, StatusPill, ChannelTag, L, cx */
/* ============================================================
   ...
   ============================================================ */
const { useState: useS, useRef: useR, useMemo: useM, useCallback: useCb } = React;
...
function useTemplateForm() {
  const [data, setData] = useS(blank);
  const [submitted, setSubmitted] = useS(false);
  const contentRef = useR(null);
...
/* ============================================================
   ...
   ============================================================ */
function DetailsFields({ f, t, lang }) {
...
function SettingsFields({ f, t, lang }) {
  const err = (k) => f.submitted && f.errors[k] ? t[f.errors[k]] : null;
  return (
    <div className="ts-grid">
...
/* ---------- section card ---------- (dictionary: .ajb-card) */
...
/* ---------- header actions ---------- (dictionary: .ajb-btn) */
...
/* ============================================================
   ...
   ============================================================ */
function DirectionA({ f, t, lang, onSave }) {
  return (
...
function DirectionB({ f, t, lang, onSave }) {
...
/* ============================================================
   ...
   ============================================================ */
function SavedCard({ f, t, lang, tplId, onList, onAnother }) {
  return (
...
/* ============================================================
   ...
   ============================================================ */
function TemplateList({ f, t, lang, tplId, justCreated }) {
  const rows = [];
  if (justCreated) {
    rows.push({
...
Object.assign(window, {
  useTemplateForm, localizedSeed, blank,
  DirectionA, DirectionB, SavedCard, TemplateList,
});
