/* global React, TPL, Icon, L, cx, Field, DetailsFields, ContentArea, SettingsFields, DevicePreview, SegmentMeter, VariablePanel, StatusPill */
/* ============================================================
   ...
   ============================================================ */
const { useState: useES, useMemo: useEM } = React;
...
/* ---------- status-aware banner ---------- */
function StatusBanner({ scenario, t, verLabel, nextLabel }) {
  if (scenario === 'errors') {
    return (
...
function VersionHistory({ versions, newVer, t, lang }) {
...
function EditActions({ scenario, t, onCancel, onSave }) {
  if (scenario === 'draft') {
    return (
...
function EditRail({ f, t, lang, versions, newVer }) {
...
/* ============================================================
   ...
   ============================================================ */
function EditWorkspace({ f, t, lang, scenario, tpl, status, verLabel, nextLabel, dirty, onCancel, onSave, versions, newVer }) {
  return (
...
/* ============================================================
   ...
   ============================================================ */
function LockedState({ t, lang, tpl, onList }) {
  return (
...
/* ============================================================
   ...
   ============================================================ */
function EditSaved({ t, lang, tpl, kind, verLabel, onBack, onView }) {
...
/* ============================================================
   DISCARD DIALOG (dictionary .ajb-dialog)
   ============================================================ */
function DiscardDialog({ t, onKeep, onDiscard }) {
  return (
...
Object.assign(window, {
  EditWorkspace, LockedState, EditSaved, DiscardDialog, VersionHistory, StatusBanner,
});
