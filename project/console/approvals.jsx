/* global React, TPL, Icon, L, cx, StatusPill, ChannelTag, DevicePreview, SegmentMeter, NeToast,
   apfmt, Avatar, PersonChip, PriorityTag, withTokens, FieldDiff, changedFields,
   ApprovalTimeline, DecisionBar, ReassignModal, SubmitModal */
/* ============================================================
   ...
   ============================================================ */
const { useState: useApS, useMemo: useApM, useEffect: useApE } = React;
...
Object.assign(window, { ApprovalsConsole });
