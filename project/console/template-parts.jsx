...
/* ============================================================
   ...
   ============================================================ */
const { useState, useRef, useEffect, useMemo, forwardRef, useCallback } = React;
...
/* ---------- Icon ----------
   Renders a persistent <i> that React owns and fills via innerHTML, instead of
   relying on the global lucide.createIcons() (which REPLACES the <i> with an
   <svg>, desyncing React's vdom and crashing reconciliation when icons change
   or live inside a changing subtree). The <i> has no JSX children, so React
   treats it as a leaf and never reconciles the swapped-in svg. */
...
Object.assign(window, {
  L, cx, Icon, Field, TextInput, DropSelect, DatePicker, ChannelPicker, ChoiceChips, LangTabs,
  HiTextarea, VariablePanel, SegmentMeter, DevicePreview, StatusPill, ChannelTag,
});
