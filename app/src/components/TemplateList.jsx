/* ============================================================
   ...
   ============================================================ */
import React, { useState as useLS, useMemo as useLM, useEffect } from 'react';
import { Link, useNavigate } from 'react-router-dom';
import Icon from './Icon';
import TPL from '../data/tpl';
import { L, cx, DropSelect, StatusPill, ChannelTag } from './TemplateParts';
    ...
    <div className="ts-page">
      <header className="tl-head">
        ...
        <div className="tl-head-r">
          ...
          <Link to="/templates/new" className="ajb-btn ajb-btn--sand"><Icon name="plus" />{t.listNew}</Link>
        </div>
      </header>
          ...
          <table className="ajb-table ts-table">
            ...
            <tbody>
              {rows.map((r) => {
                ...
                const viewUrl = `/templates/${r.detail}`;
                const canEdit = TL_EDITABLE[r.status];
                return (
                  <tr key={r.id} onClick={() => navigate(viewUrl)}>
                    <td>
