...
import { L, cx } from './TemplateParts';
import { NeToast } from './TemplateDelete';
import { CatalogTable, CatalogCards, CatalogEditor, CatalogDelete, blankItem, catalogUsage } from './SettingsCatalog';
...
/* ============================================================
   ...
   ============================================================ */
const useSS = useState, useSM = useMemo, useSE = useEffect;
